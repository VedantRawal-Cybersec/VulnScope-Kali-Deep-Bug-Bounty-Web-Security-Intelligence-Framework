...
class VulnScopeScanner:
    ...
    def run(self) -> None:
        ...
        console.print("\n[cyan][01/07] Collecting IP route intelligence...[/cyan]")
        collect_ip_route_intelligence(self.store, self.target.normalized_url)

        console.print("[cyan][02/07] Probing root target...[/cyan]")
        ...
        console.print("[cyan][03/07] Auditing security headers and cookies...[/cyan]")
        audit_headers_and_cookies(self.store, root_response)

        console.print("[cyan][04/07] Crawling same-domain pages...[/cyan]")
        ...
        console.print("[cyan][05/07] Mining JavaScript endpoints...[/cyan]")
        ...
        console.print("[cyan][06/07] Analyzing parameters and forms...[/cyan]")
        analyze_parameters(self.store)

        console.print("[cyan][07/07] Writing reports...[/cyan]")
    ...
    def _print_module_status() -> None:
        ...
        modules = [
            ...
            ("02", "HTTP Intelligence", "READY"),
            ("03", "Header & Cookie Auditor", "READY"),
            ("04", "Same-Domain Crawler", "READY"),
            ("05", "JavaScript Endpoint Miner", "READY"),
            ("06", "Parameter Intelligence", "READY"),
            ("07", "Report Generator", "READY"),
        ]
        for row in modules:
            table.add_row(*row)
        console.print(table)
