...
DASHBOARDS: dict[str, dict[str, Any]] = {
    "1": {
        ...
        "profile": "snapshot",
        "purpose": "Fast website overview, scope check, headers, basic evidence, final brief.",
        "max_cycles": 2,
        "max_workers": 4,
        "run_main_scan": True,
    ...
    "2": {
        ...
        "profile": "standard",
        "purpose": "Balanced scan with evidence correlation, reportability, Top100 status, and data bundle.",
        "max_cycles": 5,
        "max_workers": 6,
        "run_main_scan": True,
    ...
    "3": {
        ...
        "profile": "deep",
        "purpose": "Full authorized website review with autonomous modules and installed Top100 safe runners.",
        "max_cycles": 8,
        "max_workers": 8,
        "run_main_scan": True,
        "run_top100_safe": True,
    ...
    "5": {
        ...
        "profile": "top100_only",
        "purpose": "Check integrated Top100 tools and run installed safe runners only for the target.",
        "max_cycles": 0,
        "max_workers": 2,
        "run_main_scan": False,
        "run_top100_safe": True,
...
def choose_dashboard(session: dict[str, Any]) -> dict[str, Any]:
    ...
    lines = [
        ...
        f"- Top100 safe runners: `{selected['run_top100_safe']}`",
